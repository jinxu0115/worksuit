...
if (!function_exists('checkCompanyAllowd')) {

    function checkCompanyAllowd($column){
        $task_company_column_allow = TaskCompanyColumnAllow::where('company_id', user()->company_id)->first();
        return $task_company_column_allow[$column];
    }
